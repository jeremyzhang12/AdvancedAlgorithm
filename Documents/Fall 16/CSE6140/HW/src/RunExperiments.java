...
public class RunExperiments{
    ...
    public static int computeMST(Graph<Integer> g){
        ...
        //Object[] arr = Arrays.sort(pq.toArray(),pq.comparator());
        //Iterator<Edge<Integer>> it = pq.iterator();
        mst = new Graph<>();
        int i = 0;
        //System.out.println(pq.size());
        while(wholeset.size() != visited.size()){
        ...
        //System.out.println(wholeset.size() + " " + visited.size());
        return cost;
    }
